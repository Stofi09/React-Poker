...
class App extends Component {
  ...
  raiseGame = (credit) => {
    ...
    if(this.state.hasCalledOverRaise){
      ...
      this.clientRef.sendMessage('/app/calledOverRaise', JSON.stringify({
 ...
 //       this.setState({hasFolded: false});
     ...
     //   this.setState({hasFolded: true});
      ...
      if(this.state.firstRaise){
          ...
          this.clientRef.sendMessage('/app/firstRaise', JSON.stringify({
            name: this.state.name,
            credit: credit,
            type:"firstRaise",
        ...
        this.setState({hasTurned: true});
        this.clientRef.sendMessage('/app/equalCall', JSON.stringify({
          name: this.state.name,
          credit: credit,
          type:"equalCall",
          hasTurned: this.state.hasTurned
          ...
          this.setState({hasTurned: true});
          this.clientRef.sendMessage('/app/overCall', JSON.stringify({
            name: this.state.name,
            credit: credit,
  ...
  beginGame = () => {
    this.clientRef.sendMessage('/app/Join', JSON.stringify({
        name: this.state.name,
  ...
  checkGame = () => {
    this.setState({hasTurned: true});
    this.clientRef.sendMessage('/app/check', JSON.stringify({
        name: this.state.name,
   ...
   // this.setState({hasFolded: true});
    ...
    foldGame = () => {
      this.clientRef.sendMessage('/app/fold', JSON.stringify({
          name: this.state.name,
      }));
      this.setState({hasChecked: true});
   //   this.setState({hasFolded: true});
                              ...
                              onMessage={(msg) => {
                                ...
                                if (msg.turn == 6){
                                  if(this.state.result == "draw"){
                                    alert("draw");
                                    this.setState({playerCredit: this.state.playerCredit + (this.state.boardCredit/2)});
                                    this.setState({oppCredit: this.state.oppCredit + (this.state.boardCredit/2)});
                                    this.setState({boardCredit: 0});
                                  }
                                ...
                                if (msg.type === "Join"){
                                  ...
                                  if(this.state.name != msg.name){
                                    ...
                                    this.setState({boardCredit: this.state.boardCredit + msg.credit});
                                    this.setState({oppCredit: this.state.oppCredit-msg.credit});
                                  ...
                                  this.setState({turns: msg.turn});
                                    ...
                                    if(this.state.name != msg.name){
                                      ...
                                      console.log(this.state.name +""+ this.state.boardCredit+" "+msg.credit);
                                    }
                                }
