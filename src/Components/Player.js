...
const Player = ({playerCredit, setPlayerCredit,name,hasChecked,hasRaised,hasFolded,hasStarted,startGame,checkGame,playerCard1,playerCard2,turns,callRaise,firstRaise,oppRaise,overCall,hasCalledOverRaise,hasOppOnLine,foldGame}) => {
