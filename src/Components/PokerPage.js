...
const PokerPage = ({name,oppName,hasOppOnLine,hasChecked,hasRaised,hasFolded,hasStarted,startGame,checkGame,playerCredit,setPlayerCredit,boardCredit,oppCredit,cards,turns,playerCard1,playerCard2,opponentCard1,opponentCard2,callRaise,firstRaise,oppRaise,hasCalledOverRaise,overCall,foldGame}) => {
